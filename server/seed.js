...
async function seed() {
  try {
    ...
    const existingStudent = await User.findOne({ email: 'student@civicmind.com' });
    if (existingStudent) {
      existingStudent.role = 'student';
      existingStudent.name = 'Demo Student';
      existingStudent.password = '12345678';
      existingStudent.xp = 500;
      existingStudent.streak = 5;
      await existingStudent.save();
      console.log('✅ Student updated → student@civicmind.com / 12345678');
    } else {
      const student = new User({
        name: 'Demo Student',
        email: 'student@civicmind.com',
        password: '12345678',
        role: 'student',
        xp: 500,
        streak: 5,
      ...
      await student.save();
      console.log('✅ Student created → student@civicmind.com / 12345678');
    }
    ...
    console.log('   Student → student@civicmind.com / 12345678');
    console.log('   Or register new student accounts at /register');
    process.exit(0);
  } catch (err) {
